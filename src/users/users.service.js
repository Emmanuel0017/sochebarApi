...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        function UsersService_1(prisma, auditService) {
            this.prisma = prisma;
        ...
        UsersService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findMany({ select: SAFE_SELECT, orderBy: { createdAt: 'desc' } })];
                });
            });
        };
        UsersService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.findUnique({ where: { id: id }, select: SAFE_SELECT })];
                        case 1:
                            user = _a.sent();
                            if (!user)
        ...
        UsersService_1.prototype.create = function (dto, actorId) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, passwordHash, user;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.findUnique({ where: { username: dto.username } })];
                        case 1:
                            existing = _b.sent();
                            if (existing)
        ...
        UsersService_1.prototype.setStatus = function (id, isActive, actorId) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.update({ where: { id: id }, data: { isActive: isActive }, select: SAFE_SELECT })];
                        case 1:
                            user = _a.sent();
                            return [4 /*yield*/, this.auditService.log({
                                    userId: actorId,
