...
var UsersController = function () {
    var _classDecorators = [(0, common_1.Controller)('users'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN')];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.create = function (dto, user) {
            return this.usersService.create(dto, user.id);
        };
        UsersController_1.prototype.update = function (id, dto, user) {
            return this.usersService.update(id, dto, user.id);
        };
        UsersController_1.prototype.setStatus = function (id, isActive, user) {
