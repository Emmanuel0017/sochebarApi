...
var AuditController = function () {
    var _classDecorators = [(0, common_1.Controller)('audit-logs'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN', 'MANAGER')];
    ...
    var AuditController = _classThis = /** @class */ (function () {
        ...
        AuditController_1.prototype.findAll = function (entityType, entityId, userId) {
            return this.auditService.findAll({ entityType: entityType, entityId: entityId, userId: userId });
        };
