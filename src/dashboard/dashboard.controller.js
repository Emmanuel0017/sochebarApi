...
var DashboardController = function () {
    var _classDecorators = [(0, common_1.Controller)('dashboard'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN', 'MANAGER')];
    ...
    var DashboardController = _classThis = /** @class */ (function () {
        ...
        DashboardController_1.prototype.summary = function () {
            return this.dashboardService.summary();
        };
        DashboardController_1.prototype.sales = function () {
            return this.dashboardService.sales();
        };
        DashboardController_1.prototype.stockAlerts = function () {
            return this.dashboardService.stockAlerts();
        };
        DashboardController_1.prototype.cash = function () {
    ...
    (function () {
        ...
        _sales_decorators = [(0, common_1.Get)('sales')];
        _stockAlerts_decorators = [(0, common_1.Get)('stock-alerts')];
        ...
        __esDecorate(_classThis, null, _sales_decorators, { kind: "method", name: "sales", static: false, private: false, access: { has: function (obj) { return "sales" in obj; }, get: function (obj) { return obj.sales; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _stockAlerts_decorators, { kind: "method", name: "stockAlerts", static: false, private: false, access: { has: function (obj) { return "stockAlerts" in obj; }, get: function (obj) { return obj.stockAlerts; } }, metadata: _metadata }, null, _instanceExtraInitializers);
