...
var UnitsController = function () {
    var _classDecorators = [(0, common_1.Controller)('units'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var UnitsController = _classThis = /** @class */ (function () {
        function UnitsController_1(unitsService) {
            this.unitsService = (__runInitializers(this, _instanceExtraInitializers), unitsService);
        }
        UnitsController_1.prototype.findAllForProduct = function (productId) {
            return this.unitsService.findAllForProduct(productId);
        };
        UnitsController_1.prototype.create = function (dto) {
            return this.unitsService.create(dto);
        };
        UnitsController_1.prototype.update = function (id, dto) {
            return this.unitsService.update(id, dto);
        };
        UnitsController_1.prototype.remove = function (id) {
            return this.unitsService.remove(id);
        };
        return UnitsController_1;
    }());
    __setFunctionName(_classThis, "UnitsController");
    (function () {
        ...
        UnitsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UnitsController = _classThis;
}();
