...
var ExpensesController = function () {
    var _classDecorators = [(0, common_1.Controller)('expenses'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _findAllCategories_decorators;
    ...
    var ExpensesController = _classThis = /** @class */ (function () {
        ...
        ExpensesController_1.prototype.findAllCategories = function () {
            return this.expensesService.findAllCategories();
        };
        ExpensesController_1.prototype.createCategory = function (dto) {
            return this.expensesService.createCategory(dto);
        };
        ExpensesController_1.prototype.findAll = function (categoryId, from, to) {
            return this.expensesService.findAll({ categoryId: categoryId, from: from, to: to });
        };
        ExpensesController_1.prototype.findOne = function (id) {
            return this.expensesService.findOne(id);
        };
        ExpensesController_1.prototype.create = function (dto, user) {
            return this.expensesService.create(dto, user.id);
        };
        ExpensesController_1.prototype.update = function (id, dto, user) {
    ...
    (function () {
        ...
        _findAllCategories_decorators = [(0, common_1.Get)('categories')];
        _createCategory_decorators = [(0, common_1.Post)('categories'), (0, common_1.UseGuards)(roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN', 'MANAGER')];
        ...
        __esDecorate(_classThis, null, _findAllCategories_decorators, { kind: "method", name: "findAllCategories", static: false, private: false, access: { has: function (obj) { return "findAllCategories" in obj; }, get: function (obj) { return obj.findAllCategories; } }, metadata: _metadata }, null, _instanceExtraInitializers);
